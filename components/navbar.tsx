  ...
  return(
    <nav className="bg-white border-gray-200 ">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button      data-collapse-toggle="navbar-default" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100" aria-controls="navbar-default" aria-expanded="false">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-white-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white   ">
            <li>
              {
                pathname === "/"?
                  <Link href="/" className="block py-2 px-3 text-black bg-greendos rounded md:bg-transparent md:text-green-700 md:p-0  " aria-current="page">Inicio</Link>
                :              
                  <Link href="/
            ...
            <li>
              {
                  pathname === "/about"?
                    <Link href="/about" className="block py-2 px-3 text-black bg-greendos rounded md:bg-transparent md:text-green-700 md:p-0 ">Sobre nosotros</Link>
                  :
            ...
            <li>
              {
                pathname === "/contact"?
                  <Link href="/contact" className="block py-2 px-3 text-black bg-greendos rounded md:bg-transparent md:text-green-700 md:p-0  ">Contacto</Link>
                : 
            ...
            <li>
              {
                pathname === "/jobhere"?
                  <Link href="/jobhere" className="block py-2 px-3 text-black bg-greendos rounded md:bg-transparent md:text-green-700 md:p-0">Trabaja con nosotros</Link>
                :
